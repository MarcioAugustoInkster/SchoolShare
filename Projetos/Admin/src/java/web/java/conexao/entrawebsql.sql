...
INSERT INTO `schoolshare`.`instituicao` (`id`, `nome`, `endereco`, `numero`, `bairro`, `cidade`, `estado`) VALUES 
...
INSERT INTO `schoolshare`.`curso` (`id`, `instituicao_id`, `nome`) VALUES 
('1', '1', 'Programação C#'),
('2', '3', 'Programação JAVA'),
('3', '2', 'Preparação para Certificação ITIL'),
('4', '1', 'Java Script e JQuery');

INSERT INTO `schoolshare`.`turma` (`id`, `professor_id`, `curso_id`, `nome`, `data_inicio`, `data_final`, `carga_horaria`) VALUES 

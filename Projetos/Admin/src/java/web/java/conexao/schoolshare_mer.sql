...
CREATE TABLE IF NOT EXISTS `schoolshare`.`matriculas` (
  ...
  `data_inativo` DATE DEFAULT '2001-01-01',
  PRIMARY KEY (`id`),
...
(1,'Admin',3,'2018-03-01','admin@email.com','-','schoolshare','353BA90F8C0B3E0F355A3D6C960B7CAED5F2C1412992277C0669A04A62E7DFD35FBA9F4631A7DC6D00FB44D93D305CC0B749C7501D9CE86F26148D05101B8324',1,1);
